...
# Raw labels emitted by the fridge-focused YOLO checkpoint are mapped here first.
# Keep the values canonical so downstream pantry/category logic stays stable.
...
CATEGORY_KEYWORDS: Dict[Category, Set[str]] = {
    "vegetable": {"tomato", "onion", "potato", "sweet potato", "carrot", "pepper", "chili", "spinach", "broccoli", "cabbage", "cauliflower", "eggplant", "okra", "peas", "corn", "mushroom", "cucumber", "zucchini", "beet", "radish", "lettuce", "celery", "pumpkin", "squash", "gourd"},
    "fruit": {"apple", "banana", "orange", "mango", "grape", "berry", "strawberry", "blueberry", "blackberry", "lemon", "lime", "avocado", "watermelon", "melon", "papaya", "pineapple", "kiwi", "pear", "peach", "plum", "pomegranate", "guava"},
